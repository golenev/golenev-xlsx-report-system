...
function autoResizeTextarea(element) {
  ...
  const minHeight = Number.isFinite(computedMinHeight) ? computedMinHeight : MULTILINE_MIN_HEIGHT;
...
export default function App() {
  ...
  useEffect(() => {
    const textareas = document.querySelectorAll('[data-testid="test-report-table"] textarea');
    textareas.forEach(autoResizeTextarea);
  }, [items, newItems, editingScenarioIds]);
