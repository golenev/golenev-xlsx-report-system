...
class MainPage {
    ...
    private val headerTitle: SelenideElement =
        element("h1").reportAs("Заголовок страницы, по которому проверяется успешное открытие или обновление Test Report.")

    private val body: SelenideElement get() = `$`("body").reportAs("Элемент body страницы, по которому можно снять фокус с активного поля.")
