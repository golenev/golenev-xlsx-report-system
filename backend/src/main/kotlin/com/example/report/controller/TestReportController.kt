...
class TestReportController(
    ...
    @PostMapping("/allure/test-cases", consumes = [MediaType.MULTIPART_FORM_DATA_VALUE])
    fun getAllureTestCases(@RequestPart("files") files: List<MultipartFile>) =
        allureReportImportService.loadTestCases(files)
}
